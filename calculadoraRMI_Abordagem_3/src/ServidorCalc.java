...
public class ServidorCalc {
    ...
    public static void main(String[] args) {
        ...
        try {
			...
			String objmaq1 = "//localhost:1099/ soma";// or String objname = args[0]
			String objmaq2 = "//localhost:1099/ soma";// or String objname = args[0]
			String objmaq3 = "//localhost:1099/ soma";// or String objname = args[0]
			String objmaq4 = "//localhost:1099/ soma";// or String objname = args[0]
